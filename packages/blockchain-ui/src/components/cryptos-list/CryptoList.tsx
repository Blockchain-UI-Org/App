...
import { BabyDogeCoinLogo } from "./crypto-icons/BabyDogeCoinLogo";
import { BalancerLogo } from "./crypto-icons/BalancerLogo";
import { BarnBridge } from "./crypto-icons/BarnBridge";
import { BATLogo } from "./crypto-icons/BATLogo";
import { BeefyFinanceLogo } from "./crypto-icons/Beefy.FinanceLogo";
import { BiconomyLogo } from "./crypto-icons/BiconomyLogo";
...
import { BZXProtocolLogo } from "./crypto-icons/BZXProtocolLogo";
import { CardanoLogo } from "./crypto-icons/CardanoLogo";
import { CartesiLogo } from "./crypto-icons/CartesiLogo";
import { CDAILogo } from "./crypto-icons/CDAILogo";
...
import { ConvexFinanceLogo } from "./crypto-icons/ConvexFinanceLogo";
import { CosmosLogo } from "./crypto-icons/CosmosLogo";
import { CreamLogo } from "./crypto-icons/CreamLogo";
...
import { DiviLogo } from "./crypto-icons/DiviLogo";
import { EverScaleLogo } from "./crypto-icons/EverscaleLogo";
import { FetchAiLogo } from "./crypto-icons/FetchAiLogo";
...
import { FusionLogo } from "./crypto-icons/FusionLogo";
import { GalaLogo } from "./crypto-icons/GalaLogo";
import { GeminiDollarLogo } from "./crypto-icons/GeminiDollarLogo";
import { GolemLogo } from "./crypto-icons/GolemLogo";
import { HederaLogo } from "./crypto-icons/HederaLogo";
import { HuobiToken } from "./crypto-icons/HuobiToken";
import { IDEX } from "./crypto-icons/IDEX";
import { IDLELogo } from "./crypto-icons/IDLELogo";
import { INJLogo } from "./crypto-icons/INJLogo";
import { IoTeXLogo } from "./crypto-icons/IoTeXLogo";
import { KambriaLogo } from "./crypto-icons/KambriaLogo";
import { KlerosLogo } from "./crypto-icons/KlerosLogo";
import { KyberNetworkProtocol } from "./crypto-icons/KyberNetworkProtocolLogo";
import { LivepeerLogo } from "./crypto-icons/LivepeerLogo";
import { LoopRingLogo } from "./crypto-icons/LoopRingLogo";
...
import { MetalDAOLogo } from "./crypto-icons/MetalDAOLogo";
import { MXCLogo } from "./crypto-icons/MXCLogo";
import { NeoLogo } from "./crypto-icons/NeoLogo";
import { NestProtocolLogo } from "./crypto-icons/NestProtocolLogo";
import { NEXOLogo } from "./crypto-icons/NEXOLogo";
import { OceanNetworkLogo } from "./crypto-icons/OceanNetworkLogo";
// import { OneInchLogo } from "./crypto-icons/OneInchLogo";
import { PARSIQLogo } from "./crypto-icons/PARSIQLogo";
import { PAXGoldLogo } from "./crypto-icons/PAXGold";
import { PeercoinLogo } from "./crypto-icons/PeercoinLogo";
import { PlutonLogo } from "./crypto-icons/PlutonLogo";
import { PNetworkLogo } from "./crypto-icons/PNetworkLogo";
// import { OneInchLogo } from "./crypto-icons/OneInchLogo";
import { PolkdotLogo } from "./crypto-icons/PolkaDotLogo";
import { PolySwarmLogo } from "./crypto-icons/PolySwarmLogo";
import { PowerLedgerLogo } from "./crypto-icons/PowerLedgerLogo";
import { PropyLogo } from "./crypto-icons/PropyLogo";
import { ProtonLogo } from "./crypto-icons/ProtonLogo";
import { QuantLogo } from "./crypto-icons/QuantLogo";
import { QuarkChainLogo } from "./crypto-icons/QuarkChainLogo";
import { RAMPLogo } from "./crypto-icons/RAMPLogo";
import { RENLogo } from "./crypto-icons/RENLogo";
import { RequestLogo } from "./crypto-icons/RequestLogo";
import { RevainLogo } from "./crypto-icons/RevainLogo";
import { RipioCreditNetworkLogo } from "./crypto-icons/RipioCreditNetworkLogo";
import { SafeHavenLogo } from "./crypto-icons/SafeHavenLogo";
import { ShibaInuLogo } from "./crypto-icons/ShibaInuLogo";
...
import { StorjLogo } from "./crypto-icons/StorjLogo";
import { StreamRLogo } from "./crypto-icons/StreamRLogo";
import { SushiLogo } from "./crypto-icons/SushiLogo";
import { SuterusuLogo } from "./crypto-icons/SuterusuLogo";
import { SynthetixNetworkLogo } from "./crypto-icons/SynthetixNetworkLogo";
import { TelcoinLogo } from "./crypto-icons/TelcoinLogo";
import { TetherGoldLogo } from "./crypto-icons/TetherGoldLogo";
...
import { VesperFinanceLogo } from "./crypto-icons/VesperFinanceLogo";
...
type ICrypto = INativeToken | ERCToken;
 ...
 const listOfCryptos: { [x: string]: ICrypto } = {
  ...
  ramp: {
    ...
    contract: {
      polygon: "0xaecebfcf604ad245eaf0d5bd68459c3a7a6399c2",
    },
  },
  bzxprotocol: {
    name: "bZx Protocol",
    icon: BZXProtocolLogo,
    symbol: "BZRX",
  ...
  polyswarm: {
    ...
    website: "https://kleros.io/",
    contract: {
      polygon: "0x4985e0b13554fb521840e893574d3848c10fcc6f",
    },
  },
  pnetwork: {
    name: "pNetwork",
  ...
  safehaven: {
    ...
    contract: {
      ...
      polygon:"0x534f39c5f4df9cb13e16b24ca07c7c8c0e2eadb7"
    },
  },
  vesperfinance: {
    name: "Vesper Finance",
    icon: VesperFinanceLogo,
    symbol: "VSP",
    website: "https://vesper.finance/",
    contract: {
      polygon:"0x09c5a4bca808bd1ba2b8e6b3aaf7442046b4ca5b"
    },
  },
  suterusu: {
    name: "Suterusu",
