...
export const YearnFiLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" x={0} y={0} viewBox="0 0 100 100" xmlSpace="preserve" {...props}>
    <linearGradient
      id="SVGID_1_"
    ...
    />
    <path fillRule="evenodd" clipRule="evenodd" fill="#fff" d="M47.4 27.4h5.2v45.2h-5.2V27.4z" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      fill="#fff"
