...
export const FlowLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg id="svg32" xmlns="http://www.w3.org/2000/svg" x={0} y={0} viewBox="0 0 256 256" xmlSpace="preserve" {...props}>
    <g id="Layer_2_1_">
      <g id="Layer_1-2">
        <g id="g43" transform="scale(2.56)">
          ...
          />
          <path fill="#fff" d="M57.8 42.2h14.1v14.1H57.8z" />
          <path
            fill="#fff"
          ...
          />
          <path fill="#fff" d="M63.1 35.1H79V21H63.1c-10.7 0-19.4 8.7-19.4 19.4v1.8h14.1v-1.8c0-2.9 2.4-5.3 5.3-5.3z" />
          <path
            style={{
              fill: "#16ff99",
            }}
