...
const isDefined = <T,>(val: T | undefined, defaultVal: T) => (typeof val !== "undefined" ? val : defaultVal);

export type ITypographyProps = React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
  as?: ITypographyTags;
} & IFontProps;
...
const genStyles = (props: IFontProps) =>
  css({
    ...
    marginTop: isDefined(props.marginTop, 0),
    marginBottom: isDefined(props.marginBottom, 0),
  });
...
export const Subtitle: FC<ISubtitleProps> = (props) => {
  ...
  return <Typography as="h4" {...variantStyles} {...props} />;
};
